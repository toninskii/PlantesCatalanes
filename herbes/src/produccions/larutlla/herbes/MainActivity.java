...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        datos.add(new Lista_entrada(R.drawable.im_farigola, "FARIGOLA, FRIGOLA", "Les seves propietats principals serien ajudar al tractament de dolors musculars. També és un estimulant digestiu. Es fa servir en malaties com ara fibromialgia i anorexia."));
        datos.add(new Lista_entrada(R.drawable.im_fonoll, "FONOLL", "Afavoreix l'eliminació de líquids corporals, sent molt recomenada en casos d'obesitat o malalties reumàtiques. Dues gotes d'essència dissoltes en sucre tenen propietats expectorants i antitusives"));
        ...
        datos.add(new Lista_entrada(R.drawable.im_apio, "API", "Fortes propietats relanxants. També es pot fer servir en amanides i per problemes de sobrepés."));
